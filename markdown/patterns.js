  ...
  return [
    {
      ...
      transform: (tokens, i) => {
        ...
        let attrs = utils.getAttrs(token.info, options);
    ...
    },
    {
      ...
      transform: (tokens, i, j) => {
        ...
        let attrs = utils.getAttrs(token.content, options);
    ...
    },
    {
      ...
      transform: (tokens, i, j) => {
        ...
        let attrs = utils.getAttrs(content, options);
        let openingToken = utils.getMatchingOpeningToken(
          tokens[i].children,
          j - 1
        );
